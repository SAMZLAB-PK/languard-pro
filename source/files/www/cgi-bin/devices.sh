...
/* LAG FIX SPEED WIDTH START */
table{table-layout:fixed !important;}
th:nth-child(1),td:nth-child(1){width:120px !important;}
th:nth-child(2),td:nth-child(2){width:320px !important;}
th:nth-child(3),td:nth-child(3){width:220px !important;}
th:nth-child(4),td:nth-child(4){width:110px !important;}
th:nth-child(5),td:nth-child(5){width:150px !important;min-width:150px !important;max-width:150px !important;}
th:nth-child(6),td:nth-child(6){width:150px !important;min-width:150px !important;max-width:150px !important;}
th:nth-child(7),td:nth-child(7){width:130px !important;}
td[data-label="Speed"],td[data-label="Usage"]{overflow:hidden !important;}
.stackCell{width:128px !important;min-width:128px !important;max-width:128px !important;font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace !important;font-variant-numeric:tabular-nums !important;}
.stackLine{display:grid !important;grid-template-columns:34px 82px !important;gap:4px !important;align-items:center !important;line-height:16px !important;min-height:16px !important;}
.stackLabel{width:34px !important;min-width:34px !important;max-width:34px !important;}
.stackValue,.trafficMini,.numMini{display:inline-block !important;width:82px !important;min-width:82px !important;max-width:82px !important;text-align:right !important;white-space:nowrap !important;overflow:hidden !important;font-variant-numeric:tabular-nums !important;}
.hm b{display:inline-block !important;min-width:96px !important;text-align:center !important;font-variant-numeric:tabular-nums !important;font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace !important;}
.status,.type,.limtag{min-height:27px !important;}
td{height:76px !important;}
@media(max-width:900px){
  table{table-layout:auto !important;}
  th:nth-child(1),td:nth-child(1),th:nth-child(2),td:nth-child(2),th:nth-child(3),td:nth-child(3),th:nth-child(4),td:nth-child(4),th:nth-child(5),td:nth-child(5),th:nth-child(6),td:nth-child(6),th:nth-child(7),td:nth-child(7){width:auto !important;min-width:0 !important;max-width:none !important;}
  td{height:auto !important;}
  .stackCell{width:130px !important;min-width:130px !important;}
  .stackLine{grid-template-columns:38px 86px !important;}
  .stackValue,.trafficMini,.numMini{width:86px !important;min-width:86px !important;max-width:86px !important;}
}
/* LAG FIX SPEED WIDTH END */
/* HEADER PADDING FIX START */
.top{
...
@media(max-width:1180px){
  ...
  .sub{white-space:normal !important;}
  .headerMetrics{grid-template-columns:repeat(2,minmax(150px,1fr)) !important;width:100% !important;}
  .topActions{justify-content:flex-start !important;}
}
/* HEADER PADDING FIX END */
/* HIDE MANAGE PAUSE BADGE START */
#editBadge,.editBadge{
...
/* HIDE MANAGE PAUSE BADGE END */
/* DELETED RESTORE DIRECT START */
#editBadge,.editBadge{display:none !important;visibility:hidden !important;width:0 !important;height:0 !important;min-width:0 !important;min-height:0 !important;padding:0 !important;margin:0 !important;border:0 !important;overflow:hidden !important;}
td[data-label="Actions"] .deletedRestoreBtn{min-width:92px !important;}
/* DELETED RESTORE DIRECT END */
/* LANGUARD TOOLS BUTTON START */
.topActions a.btn{display:inline-flex !important;align-items:center !important;justify-content:center !important;text-decoration:none !important;}
/* LANGUARD TOOLS BUTTON END */
/* SCHEDULE IN LIMITS START */
.scheduleBox{
  margin-top:12px !important;
  padding:12px !important;
  border:1px solid rgba(142,164,194,.18) !important;
...
body.theme-light .scheduleBox,body.theme-immortal .scheduleBox{
  background:#f8fafc !important;
  border-color:#d6dee8 !important;
}
body.theme-light .scheduleMini,body.theme-immortal .scheduleMini{
  color:#64748b !important;
}
body.theme-light .scheduleBox h3,body.theme-immortal .scheduleBox h3{
  color:#111827 !important;
}
/* SCHEDULE IN LIMITS END */
/* UNKNOWN DEVICE PROTECTION START */
.unknownRow td{background:#fff7ed !important;}
.unknownBadge{display:inline-flex;align-items:center;justify-content:center;min-width:84px;margin-top:6px;padding:5px 8px;border-radius:4px;background:#fed7aa;color:#9a3412;font-size:11px;font-weight:900;}
.trustedBadge{display:inline-flex;align-items:center;justify-content:center;min-width:84px;margin-top:6px;padding:5px 8px;border-radius:4px;background:#dcfce7;color:#15803d;font-size:11px;font-weight:900;}
body.theme-immortal .unknownRow td{background:#fff7ed !important;}
body.theme-light .unknownRow td{background:#fff7ed !important;}
/* UNKNOWN DEVICE PROTECTION END */
/* SPEED PROFILES START */
.profileBox{
  margin-top:12px !important;
  padding:12px !important;
  border:1px solid rgba(142,164,194,.18) !important;
...
.profileBtn.green{background:#16a34a !important;}
.profileBtn.gray{background:#64748b !important;}
.profileBtn.amber{background:#d97706 !important;}
.profileBtn.purple{background:#7c3aed !important;}
.profileHint{
...
body.theme-light .profileBox,body.theme-immortal .profileBox{
  background:#f8fafc !important;
  border-color:#d6dee8 !important;
}
body.theme-light .profileBox h3,body.theme-immortal .profileBox h3{
  color:#111827 !important;
}
body.theme-light .profileHint,body.theme-immortal .profileHint{
  color:#64748b !important;
}
/* SPEED PROFILES END */
/* COMPACT LIMITS MODAL START */
#limitModal{
...
#limitModal .checkrow input,
#limitModal .check input{
...
#limitModal .modalActions .btn{
  padding:8px 11px !important;
  font-size:12px !important;
}
body.theme-immortal #limitModal .modalActions,
body.theme-light #limitModal .modalActions{
  background:#fff !important;
}
@media(max-width:650px){
  #limitModal{padding-top:8px !important;}
  #limitModal .modal{max-height:94vh !important;width:98vw !important;}
  #limitModal .grid2,#lgScheduleBox .grid2{grid-template-columns:1fr !important;}
  .profileBtn{flex:1 1 auto !important;}
}
/* COMPACT LIMITS MODAL END */
/* DEVICE DETAILS START */
.detailsBtn{background:#0ea5e9 !important;}
/* DEVICE DETAILS END */
/* REMOVE REFRESH BUTTON START */
.topActions button[onclick*="forceRefresh"],
.topActions a[onclick*="forceRefresh"]{
  display:none !important;
}
/* REMOVE REFRESH BUTTON END */
/* REMOVE HEALTH TOP BUTTON START */
.topActions a[href*="languard-health.sh"],
.topActions button#lgHealthBtn,
.topActions a#lgHealthBtn{
  display:none !important;
}
/* REMOVE HEALTH TOP BUTTON END */
</style>
</head>
<body>
<div class="wrap">
...
<!-- IMMORTAL PATCH ACTIVE -->
  ...
  <div class="panel">
    <div class="toolbar">
      ...
      <div class="modeBadge" id="modeBadge">All devices</div>
  ...
  <div class="modal">
    ...
    <div class="checkrow">
      ...
      <div>
        ...
        <div class="hint">Disabling this will remove speed and data rules.</div>
      </div>
    </div>
    ...
    <div class="scheduleBox" id="lgScheduleBox">
      <h3>Schedule Control</h3>

      <div class="checkrow" style="margin:8px 0">
        <input type="checkbox" id="schEnabled">
        <div>
          <b>Enable internet schedule</b>
          <div class="hint">Internet is allowed only during the selected time window. Outside that window, it will be blocked automatically.</div>
        </div>
      </div>
      ...
      <div class="grid2">
        <div class="field">
          ...
          <input class="inputbox" id="schStart" type="time" value="08:00">
        </div>
        <div class="field">
          <label>Allowed Until</label>
          <input class="inputbox" id="schEnd" type="time" value="23:00">
        </div>
      </div>

      <div class="scheduleMini">Example: 08:00 to 23:00 allows internet during the day and blocks it at night.</div>
    </div>
...
async function saveDevice(mac,type){
  ...
  await callAction('/cgi-bin/languard-action-audit.sh?action=save&mac='+enc(mac)+'&name='+enc(name)+'&ip='+enc(ip));
}

async function blockDevice(mac){await callAction('/cgi-bin/languard-action-audit.sh?action=block&mac='+enc(mac));}
async function unblockDevice(mac){await callAction('/cgi-bin/languard-action-audit.sh?action=unblock&mac='+enc(mac));}
async function deleteDevice(mac){await callAction('/cgi-bin/languard-action-audit.sh?action=delete&mac='+enc(mac));}
async function restoreDevice(mac){await callAction('/cgi-bin/languard-action-audit.sh?action=restore&mac='+enc(mac));}
...
async function saveLimits(){
  ...
  await callAction('/cgi-bin/languard-action-audit.sh?action=limit_save&mac='+enc(mac)+'&enabled='+enc(enabled)+'&dl='+enc(dl)+'&ul='+enc(ul)+'&data='+enc(data));
  closeLimits();
}

async function clearLimits(){
  const mac=document.getElementById('lmMac').value;
  await callAction('/cgi-bin/languard-action-audit.sh?action=limit_clear&mac='+enc(mac));
  closeLimits();
}

async function resetUsage(){
  const mac=document.getElementById('lmMac').value;
  await callAction('/cgi-bin/languard-action-audit.sh?action=usage_reset&mac='+enc(mac));
...
function setFilter(f){
  ...
  const labels={all:'All devices',online:'Online devices',offline:'Offline devices',blocked:'Blocked devices',tailscale:'Tailscale devices'};
  const card=document.getElementById(map[activeFilter]||'totalCard');
  if(card) card.classList.add('active');
  document.getElementById('modeBadge').textContent=labels[activeFilter]||'All devices';
  loadData(true);
}
...
(function(){
  ...
  function applyTheme(themeId){
    ...
    document.body.className = document.body.className.split(/\s+/).filter(c => c.indexOf("theme-") !== 0).join(" ");
  ...
  function bindThemeButton(){
    const current = localStorage.getItem("lgTheme") || "immortal";
    if(current !== "immortal" && current !== "light"){
...
// DELETED RESTORE DIRECT START
(function(){
  function makeDeletedRestoreDirect(){
    try{
      if(typeof deletedMode === "undefined" || !deletedMode) return;
      document.querySelectorAll("#rows tr").forEach(function(tr){
        const td = tr.querySelector("td[data-label=\"Actions\"]");
        if(!td) return;
        const restoreBtn = td.querySelector("button[onclick^=\"restoreDevice\"]");
        if(!restoreBtn) return;
        restoreBtn.classList.add("deletedRestoreBtn");
  ...
  if(typeof renderRows === "function"){
    const oldRenderRows = renderRows;
    renderRows = function(){
      oldRenderRows();
      makeDeletedRestoreDirect();
    };
  }

  window.makeDeletedRestoreDirect = makeDeletedRestoreDirect;
  setTimeout(makeDeletedRestoreDirect, 300);
})();
// DELETED RESTORE DIRECT END
// LANGUARD TOOLS BUTTON START
(function(){
  function addToolsButton(){
    if(document.getElementById("lgToolsBtn")) return;
    var t=document.querySelector(".topActions");
    if(!t) return;
    var a=document.createElement("a");
    a.id="lgToolsBtn";
    a.className="btn gray";
    a.href="/cgi-bin/languard-maintenance.sh";
    a.target="_blank";
    a.textContent="Tools";
    t.appendChild(a);
  }
  if(document.readyState==="loading"){document.addEventListener("DOMContentLoaded",addToolsButton);}else{addToolsButton();}
})();
// LANGUARD TOOLS BUTTON END
// UNKNOWN DEVICE PROTECTION START
(function(){
  window.lgTrustedMacs = new Set();

  function isMac(x){
    return /^[0-9a-f]{2}(:[0-9a-f]{2}){5}$/.test(String(x || "").toLowerCase());
  }

  function macId(mac){
    return String(mac || "").replace(/[^a-zA-Z0-9]/g, "");
  }

  async function loadTrusted(){
    try{
      const r = await fetch("/cgi-bin/languard-trust.sh?action=list&_=" + Date.now(), {cache:"no-store"});
      const t = await r.text();
      const s = new Set();
      t.split("\n").forEach(function(line){
        const p = line.split("|");
        const m = String(p[0] || "").toLowerCase().trim();
        if(isMac(m)) s.add(m);
      });
      window.lgTrustedMacs = s;
      return s;
    }catch(e){
      return window.lgTrustedMacs || new Set();
    }
  }

  window.trustDevice = async function(mac, name){
    mac = String(mac || "").toLowerCase();
    try{
      const r = await fetch("/cgi-bin/languard-trust.sh?action=trust&mac=" + encodeURIComponent(mac) + "&name=" + encodeURIComponent(name || "") + "&_=" + Date.now(), {cache:"no-store"});
      const t = await r.text();
      if(t.indexOf("OK|trusted|") === -1){
        alert(t || "Trust failed");
        return;
      }
      window.lgTrustedMacs.add(mac);
      await loadTrusted();
  ...
  window.untrustDevice = async function(mac){
    mac = String(mac || "").toLowerCase();
    try{
      const r = await fetch("/cgi-bin/languard-trust.sh?action=untrust&mac=" + encodeURIComponent(mac) + "&_=" + Date.now(), {cache:"no-store"});
      const t = await r.text();
      if(t.indexOf("OK|untrusted|") === -1){
        alert(t || "Untrust failed");
        return;
      }
      window.lgTrustedMacs.delete(mac);
      await loadTrusted();
      if(typeof renderRows === "function") renderRows();
    }catch(e){
      alert("Untrust failed: " + e.message);
    }
  };

  function postUnknown(){
    try{
      ...
      devices.forEach(function(d){
        ...
        tr.classList.remove("unknownRow");
        tr.querySelectorAll(".unknownBadge,.trustedBadge,.unknownTrustBtn,.unknownUntrustBtn").forEach(function(x){x.remove();});

        const stateCell = tr.querySelector("td[data-label=\"State\"] .stateStack") || tr.querySelector("td[data-label=\"State\"]");
        const actionCell = tr.querySelector("td[data-label=\"Actions\"]");
        const trusted = window.lgTrustedMacs.has(mac);

        if(trusted){
          if(stateCell){
            const b = document.createElement("span");
            b.className = "trustedBadge";
            b.textContent = "TRUSTED";
            stateCell.appendChild(b);
          }
        }else{
          unknownCount++;
          tr.classList.add("unknownRow");

          if(stateCell){
            const b = document.createElement("span");
            b.className = "unknownBadge";
            b.textContent = "UNKNOWN";
            stateCell.appendChild(b);
          }

          if(actionCell){
            const menu = actionCell.querySelector(".actionMenu");
            const holder = menu || actionCell.querySelector(".actions") || actionCell;
            const btn = document.createElement("button");
            btn.className = "btn small green unknownTrustBtn";
            btn.textContent = "Trust";
            btn.onclick = function(ev){
              if(ev) ev.stopPropagation();
              trustDevice(mac, d.name || "");
            };
      ...
      if(modeBadge){
        const base = modeBadge.textContent.split(" · Unknown")[0] || "All devices";
        modeBadge.textContent = unknownCount > 0 ? base + " · Unknown " + unknownCount : base;
      }
    }catch(e){}
  }
  ...
  if(typeof loadData === "function"){
    ...
    loadData = async function(force){
      await oldLoadData(force);
      await loadTrusted();
      postUnknown();
    };
  }

  loadTrusted().then(function(){
    setTimeout(postUnknown, 400);
  });
})();
// UNKNOWN DEVICE PROTECTION END
// SPEED PROFILES START
(function(){
  function ensureProfileBox(){
    if(document.getElementById("lgProfileBox")) return;
    ...
    box.innerHTML = `
      ...
      <div class="profileBtns">
        <button type="button" class="profileBtn gray" onclick="applySpeedProfile(0,0,0,false)">Unlimited</button>
        <button type="button" class="profileBtn" onclick="applySpeedProfile(125,125,0,true)">1 Mbps</button>
        <button type="button" class="profileBtn" onclick="applySpeedProfile(250,125,0,true)">2 Mbps</button>
        <button type="button" class="profileBtn" onclick="applySpeedProfile(625,250,0,true)">5 Mbps</button>
        <button type="button" class="profileBtn amber" onclick="applySpeedProfile(125,64,5,true)">Kids Mode</button>
        <button type="button" class="profileBtn purple" onclick="applySpeedProfile(250,128,10,true)">Guest Mode</button>
        <button type="button" class="profileBtn green" onclick="applySpeedProfile(750,250,0,true)">TV / Streaming</button>
      </div>
      <div class="profileHint">KBps values: 125 KBps ≈ 1 Mbps. After selecting a profile, click Save Limits.</div>
    `;

    grid.parentNode.insertBefore(box, grid);
  }

  window.applySpeedProfile = function(dl, ul, data, enabled){
    ensureProfileBox();

    var en = document.getElementById("lmEnabled");
    var dlEl = document.getElementById("lmDl");
    var ulEl = document.getElementById("lmUl");
    var dataEl = document.getElementById("lmData");

    if(en) en.checked = !!enabled;
    if(dlEl) dlEl.value = String(dl);
    if(ulEl) ulEl.value = String(ul);
    if(dataEl) dataEl.value = String(data);
  };

  if(typeof openLimits === "function"){
    var oldOpenLimitsProfile = openLimits;
    openLimits = function(mac){
      oldOpenLimitsProfile(mac);
      setTimeout(ensureProfileBox, 80);
    };
  }

  if(document.readyState === "loading"){
    document.addEventListener("DOMContentLoaded", function(){
      setTimeout(ensureProfileBox, 300);
    });
  }else{
    setTimeout(ensureProfileBox, 300);
  }
...
// DEVICE DETAILS START
(function(){
  function lgMacId(mac){return String(mac||"").replace(/[^a-zA-Z0-9]/g,"");}

  window.openDeviceDetails = function(mac){
    window.open("/cgi-bin/languard-device-details.sh?mac=" + encodeURIComponent(mac), "_blank");
  };
  ...
  function addDetailsButtons(){
    try{
      ...
      devices.forEach(function(d){
        ...
        var id = lgMacId(mac);
        var ipEl = document.getElementById("ip_" + id);
        if(!ipEl) return;

        var tr = ipEl.closest("tr");
        if(!tr) return;

        var actionCell = tr.querySelector("td[data-label=\"Actions\"]");
        if(!actionCell) return;

        actionCell.querySelectorAll(".detailsBtn").forEach(function(x){x.remove();});

        var holder = actionCell.querySelector(".actionMenu") || actionCell.querySelector(".actions") || actionCell;
        var btn = document.createElement("button");
        btn.className = "btn small detailsBtn";
        btn.textContent = "Details";
        btn.onclick = function(ev){
          if(ev) ev.stopPropagation();
          openDeviceDetails(mac);
        };
        holder.insertBefore(btn, holder.firstChild);
      });
    }catch(e){}
  ...
  if(typeof renderRows === "function"){
    var oldRenderRowsDetails = renderRows;
    renderRows = function(){
      oldRenderRowsDetails();
      addDetailsButtons();
    };
  }

  if(typeof loadData === "function"){
    var oldLoadDataDetails = loadData;
    loadData = async function(force){
      await oldLoadDataDetails(force);
      addDetailsButtons();
    };
  }

  setTimeout(addDetailsButtons, 600);
})();
// DEVICE DETAILS END
// LANGUARD LOGOUT BUTTON START
(function(){
  function addLogoutButton(){
    if(document.getElementById("lgLogoutBtn")) return;
    var t=document.querySelector(".topActions");
    if(!t) return;
    ...
    b.onclick=async function(){
      await fetch("/cgi-bin/languard-auth.sh?action=logout&_="+Date.now(),{cache:"no-store",credentials:"same-origin"});
      location.href="/cgi-bin/languard-login.sh";
    };
    t.appendChild(b);
  }
  if(document.readyState==="loading"){document.addEventListener("DOMContentLoaded",addLogoutButton);}else{addLogoutButton();}
})();
// LANGUARD LOGOUT BUTTON END
// REMOVE REFRESH BUTTON START
(function(){
  function removeRefreshButton(){
    var area=document.querySelector(".topActions");
    if(!area) return;
    area.querySelectorAll("button,a").forEach(function(el){
      var txt=(el.textContent||"").trim().toLowerCase();
      var oc=(el.getAttribute("onclick")||"").toLowerCase();
      if(txt==="refresh" || oc.indexOf("forcerefresh")>-1){
        el.remove();
      }
    });
  }
  if(document.readyState==="loading"){
    document.addEventListener("DOMContentLoaded",removeRefreshButton);
  }else{
    removeRefreshButton();
  }
  setTimeout(removeRefreshButton,500);
})();
// REMOVE REFRESH BUTTON END
// REMOVE HEALTH TOP BUTTON START
(function(){
  function removeHealthTopButton(){
    var area=document.querySelector(".topActions");
    if(!area) return;
    area.querySelectorAll("button,a").forEach(function(el){
      var txt=(el.textContent||"").trim().toLowerCase();
      ...
      if(txt==="health" || href.indexOf("languard-health.sh")>-1 || id==="lghealthbtn"){
        el.remove();
      }
    });
  }
  if(document.readyState==="loading"){
    document.addEventListener("DOMContentLoaded",removeHealthTopButton);
  }else{
    removeHealthTopButton();
  }
  setTimeout(removeHealthTopButton,500);
})();
// REMOVE HEALTH TOP BUTTON END
</script>
<script>
// SCHEDULE IN LIMITS START
(function(){
  window.lgSchedules = window.lgSchedules || {};

  function lgMacId(mac){
    return String(mac || "").replace(/[^a-zA-Z0-9]/g, "");
  }

  async function loadSchedule(mac){
    try{
      const r = await fetch("/cgi-bin/languard-schedule.sh?action=get&mac=" + encodeURIComponent(mac) + "&_=" + Date.now(), {cache:"no-store"});
      const t = await r.text();
      const line = (t.trim().split("\n").pop() || "");
      const p = line.split("|");

      let enabled = "0", start = "08:00", end = "23:00";
      ...
      const st = document.getElementById("schStart");
      const ed = document.getElementById("schEnd");

      if(en) en.checked = enabled === "1";
      ...
      if(ed) ed.value = "23:00";
    }
  }

  async function saveSchedule(mac){
    const en = document.getElementById("schEnabled");
    const st = document.getElementById("schStart");
    const ed = document.getElementById("schEnd");

    const enabled = en && en.checked ? "1" : "0";
    const start = st && st.value ? st.value : "08:00";
    const end = ed && ed.value ? ed.value : "23:00";

    await fetch(
      "/cgi-bin/languard-schedule.sh?action=save&mac=" + encodeURIComponent(mac) +
  ...
  async function loadScheduleList(){
    try{
      const r = await fetch("/cgi-bin/languard-schedule.sh?action=list&_=" + Date.now(), {cache:"no-store"});
      const t = await r.text();
      const map = {};
      ...
      window.lgSchedules = map;
    }catch(e){}
  }

  function postProcessScheduleTags(){
    try{
      if(typeof devices === "undefined") return;

      devices.forEach(function(d){
        const mac = String(d.mac || "").toLowerCase();
        const s = window.lgSchedules[mac];
        const id = lgMacId(mac);
        const ipEl = document.getElementById("ip_" + id);

        if(!ipEl) return;

        const tr = ipEl.closest("tr");
        if(!tr) return;

        tr.querySelectorAll(".scheduleTag").forEach(function(x){x.remove();});

        if(s && s.enabled === "1"){
          const limitCell = tr.querySelector("td[data-label=\"Limit\"]");
          if(limitCell){
            const tag = document.createElement("span");
            tag.className = "scheduleTag";
            tag.textContent = "SCHED " + (s.start || "") + "-" + (s.end || "");
            limitCell.appendChild(document.createElement("br"));
            limitCell.appendChild(tag);
          }
        }
      });
    }catch(e){}
  ...
  if(typeof openLimits === "function"){
    const oldOpenLimits = openLimits;
    openLimits = function(mac){
      oldOpenLimits(mac);
      setTimeout(function(){
        loadSchedule(mac);
  ...
  if(typeof saveLimits === "function"){
    const oldSaveLimits = saveLimits;
    saveLimits = async function(){
      const macEl = document.getElementById("lmMac");
      const mac = macEl ? macEl.value : "";

      if(mac) await saveSchedule(mac);

      await oldSaveLimits();

      await loadScheduleList();
      postProcessScheduleTags();
    };
  }
  ...
  loadScheduleList().then(function(){
    setTimeout(postProcessScheduleTags, 500);
  });
})();
// SCHEDULE IN LIMITS END
// UNKNOWN DEVICE PROTECTION START
